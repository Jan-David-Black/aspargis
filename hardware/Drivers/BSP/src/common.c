...
{
	printf("Welcome to our personal software ###### JDF 03");
...
{	
	...
	{
		Sensor->adc0 = ADCModel(ADC_CHANNEL_0);
		Sensor->temDs18b20_1 = DS18B20_GetTemp_SelectRom(1)*10;DS18B20_IoDeInit(1);
		Sensor->temDs18b20_2 = DS18B20_GetTemp_SelectRom(2)*10;DS18B20_IoDeInit(1);
		Sensor->temDs18b20_3 = DS18B20_GetTemp_SelectRom(3)*10;DS18B20_IoDeInit(1);
		Sensor->temDs18b20_4 = DS18B20_GetTemp_SelectRom(4)*10;DS18B20_IoDeInit(1);
		...
		sprintf(Sensor->data+strlen(Sensor->data), "%c", (Sensor->temDs18b20_4>=0)?'0':'F');
		sprintf(Sensor->data+strlen(Sensor->data), "%.3x",(Sensor->temDs18b20_4>=0)?Sensor->temDs18b20_3:Sensor->temDs18b20_3*(-1));	
	}
